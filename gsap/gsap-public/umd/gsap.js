	...
	var Timeline = ((_Animation) => {
		...
		_proto2.totalDuration = function totalDuration(value) {
			...
			if (this._dirty) {
				...
				_setDuration(
					this,
					this === _globalTimeline && this._time > max ? this._time : max,
					1,
					1,
				);
	...
	var _win$1,
			...
			if (property in _transformProps && style) {
				...
				if (property !== "transform") {
					...
					~property.indexOf(",")
						? property
								.split(",")
								.forEach((a) => (this.tfm[a] = _get(target, a)))
		...
		_getStyleSaver = function _getStyleSaver(target, properties) {
			...
			properties &&
				target.style &&
				target.nodeType &&
				properties.split(",").forEach((p) => saver.save(p));
			return saver;
		},
		_supports3D,
