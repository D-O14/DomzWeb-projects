...
## features
- Has timer to check state
- Runs until fetch succceeds
- Continously checks online state
- Adaptability to change of state 
...
## ideas
- Pass in object paramterse
- Use API data passed in argument
- Dynamic title content based on state chang
